...
fn cmd_send(ledger: &mut accounts::Accounts, tx_log: &mut Vec<tx::Tx>, amount: &&str, from: &&str, to: &&str) {
...
fn cmd_deposit(ledger: &mut accounts::Accounts, tx_log: &mut Vec<tx::Tx>, amount: &&str, signer: &&str) {
    if let Ok(amount) = amount.parse::<u64>() {
...
fn cmd_withdraw(ledger: &mut accounts::Accounts, tx_log: &mut Vec<tx::Tx>, amount: &&str, signer: &&str) {
    if let Ok(amount) = amount.parse::<u64>() {
